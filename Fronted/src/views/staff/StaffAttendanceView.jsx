    ...
    <div className="view-container attendance-view">
      ...
      <div className="attendance-layout">
        ...
        <section className="card attendance-history-card">
          <SectionHeader eyebrow="Trazabilidad" title="Últimos registros" description="Los eventos provienen de `/api/attendance/events`." action={<button type="button" className="icon-button" title="Actualizar registros" aria-label="Actualizar registros" onClick={reload}><RefreshCw size={16} aria-hidden="true" /></button>} />
